...
**Core Value:** A hospitality operator's data — invoices, costs, tips, sales — stays on their own infrastructure, visible only to them, and the tools that process it are open-source and auditable.
